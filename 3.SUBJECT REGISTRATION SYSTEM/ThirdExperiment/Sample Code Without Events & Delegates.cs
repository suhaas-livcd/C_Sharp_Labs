...
namespace SubjectRegistrationSystem
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            index =initialisestudent(student);
            initialisevalue(subjects);
            initialisemenu(subjects,index,student,regsubjects);

        }

        public static void initialisemenu(List<SubjectRegistration> subjects, int studentindex, List<UniversityStudents> student, List<RegisteredSubject> regsubjects) {
        ...
        public static void registersubject(List<SubjectRegistration> subjects, int studentindex, List<UniversityStudents> student,List<RegisteredSubject> regsubjects) {
        ...
        public static void deregistersubject(List<SubjectRegistration> subjects, int studentindex, List<UniversityStudents> student, List<RegisteredSubject> regsubjects) {
        ...
        public static void generatetimetable(List<SubjectRegistration> subjects, int studentindex, List<UniversityStudents> student, List<RegisteredSubject> regsubjects) {
        ...
        public static int initialisestudent(List<UniversityStudents> student) {
